...
time mpirun -n $cpu --oversubscribe python3 ./colonies.py --data_dir $dataFolder --data_files c172_file_1.csv --input_names $INPUT --output_names $OUTPUT --log_dir LOG_single_cantsbp --out_dir OUT_single_cantsbp --living_time 1000  --term_log_level INFO --log_file_name cants_trial_$f_name_$i --file_log_level INFO --col_log_level INFO -nrm minmax
